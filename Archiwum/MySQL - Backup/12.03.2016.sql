...
--
-- Host: 127.0.0.1
-- Czas generowania: 12 Mar 2016, 23:40
...
CREATE TABLE `minertech` (
  ...
  `FIRST_NICK` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `EXP` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `LVL` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `REWARDS` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ACHIEVEMENT` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, '43e14ef4-9853-492d-bf19-4048dfcc0c73', 'dom133', '2550', '2', 'BRICK[64],PISTON_STICKY_BASE[10]', NULL);
...
INSERT INTO `users` (`Session_id`, `User`, `Poziom`, `Klucz_a`, `Aktywne`, `avatar`) VALUES
('zpUJCL9chbX3W8uslzi0ZYwmxhEOp2', 'dom133', 2, 'PEOJAsi8C8oHsIjk2RMmOC2EMCJxpZ0NF0QS2nsyrdhamJHBNz', 'nie', NULL);
