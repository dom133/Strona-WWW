...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pl" lang="pl">
	...
	<div class="head-bar">
		<div class="wrapper">
			<ul class="menu">
                	<li><a href="http://skymin.pl/index.php">Strona Główna</a></li>
                    <li><a href="http://skymin.pl/index.php?skymin=launcher">Launcher - Download</a></li>
                    <li><a href="http://skymin.pl/index.php?skymin=forum">Forum</a></li>
					<li><a href="http://skymin.pl/index.php?skymin=statystyki">Statystyki</a></li>
			</ul>
           <div class="right">
                ...
                <div id="informacja">
                    <div class="msg">
                      <script type="text/javascript">
						...
						{
							show_msg('<p class=ok>Konto nie zostało aktywowane, jeżeli nie przyszedł email z kodem aktywacyjnym kliknij w <a href="index.php?login=re-kod_aktywacyjny" >ten link</a></p>', '#informacja .msg', '#informacja .msg .ok', 15000);
                ...
                <div id="informacja">
                    <div class="msg">
                      <script type="text/javascript">
					  	if(readCookie("akt_komunikat")=="false")
						{
							show_msg('<p class=ok>Konto nie zostało aktywowane, jeżeli nie przyszedł email z kodem aktywacyjnym kliknij w <a href="index?login=re-kod_aktywacyjny" >ten link</a></p>', '#informacja .msg', '#informacja .msg .ok', 15000);
