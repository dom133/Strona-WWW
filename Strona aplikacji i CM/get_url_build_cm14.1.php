...
shell_exec('echo '.$jenkinsID.' > /var/www/html/updates/txt/jenkins_id_cm14.1.txt');
shell_exec('echo '.$date.' > /var/www/html/updates/txt/date_cm14.1.txt');
